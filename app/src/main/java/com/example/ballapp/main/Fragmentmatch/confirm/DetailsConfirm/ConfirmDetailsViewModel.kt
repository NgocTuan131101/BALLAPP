...
import com.example.ballapp.main.Fragmentmatch.confirm.ConfirmViewModel
...
@HiltViewModel
class ConfirmDetailsViewModel @Inject constructor(private val confirmDetailsRepository: ConfirmDetailsRepostiory) : ViewModel() {
