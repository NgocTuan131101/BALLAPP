    ...
    private fun login() {
        ...
        callbacks = object:PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onCodeSent(
                ...
                resendToken = token
                /*
                  - Token  :ứng dụng sẽ gửi token này cùng với
                  yêu cầu đến máy chủ để xác minh danh tính người dùng.
                  - Token cũng có thể được sử dụng để truy cập các API bảo mật, cho phép người
                    dùng sử dụng các dịch vụ của bạn mà không cần phải nhập lại
                    thông tin đăng nhập mỗi lần họ sử dụng ứng dụng.
